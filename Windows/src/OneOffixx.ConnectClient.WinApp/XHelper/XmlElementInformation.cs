...
namespace OneOffixx.ConnectClient.WinApp.XHelper
{
    ...
    {
        public XmlElementQualifiedNameCollection elements = new XmlElementQualifiedNameCollection();
        public  XmlNamespaceCollection namespacesInScope = new XmlNamespaceCollection();
